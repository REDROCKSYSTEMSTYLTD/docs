...
Service agreements are legally binding under the NDIS Rules 2018. A service agreement is the formal document between your organisation and a participant (or their representative) that sets out what support coordination services will be provided, under what conditions, and at what rates.

<Frame>
  <img src="/images/service-agreements/sa-list.png" alt="Service agreement list for a participant showing status, plan period, and support items covered" />
</Frame>
...
| Status | Meaning |
|---|---|
| <Badge variant="secondary">Draft</Badge> | Being prepared — not yet sent to the participant |
| <Badge variant="warning">Sent</Badge> | Provided to the participant or their representative for signing |
| <Badge variant="success">Signed</Badge> | Returned with a signature — document uploaded to CoordHub |
| <Badge variant="success">Active</Badge> | Current, signed service agreement in effect |
| <Badge variant="secondary">Expired</Badge> | Plan period has ended or a new agreement supersedes this one |
| <Badge variant="secondary">Superseded</Badge> | Replaced by a new version before being signed |
