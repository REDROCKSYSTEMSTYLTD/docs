...
<iframe src="https://tours.coordhub.au/tours/budget-forecast/" style={{ width: '100%', height: '560px', border: 'none', borderRadius: '10px', marginBottom: '8px', display: 'block' }} title="Interactive tour: Budget Forecast" loading="lazy" />

<video autoPlay muted playsInline controls src="/videos/budget-forecast-flow.webm" style={{ width: '100%', borderRadius: '8px', border: '1px solid #e5e7eb', marginBottom: '8px' }} />

<Frame>
  <img src="/images/finance/budget-forecast.png" alt="Budget forecast summary bar showing Total Allocated, Total Remaining, and Unsubmitted amounts" />
</Frame>

<sub>**Allocated** — total plan funding &nbsp; **Remaining** — budget left to spend &nbsp; **Pending** — approved work not yet invoiced</sub>
