...
<Frame>
  <img src="/images/finance/budget-forecast.png" alt="Budget forecast table showing all participants with allocated, spent, remaining, burn rate, and health status columns" />
</Frame>
